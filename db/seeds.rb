...
@car_4 = Car.create!(dealership_id: @dealership_2.id, name: "BMW M5", created_at: DateTime.new(2013, 7, 2, 11, 09, 15), updated_at: DateTime.new(2020, 3, 10, 12, 15, 30), inspected: true, price: 42999.99)
...
@produce_item_2 = ProduceItem.create!(farmers_market_stand_id: @stand_1.id, type: "cherries", DateTime.new(2021, 4, 14, 9, 03, 30), updated_at: DateTime.new(2020, 3, 10, 12, 15, 30), weight: 2.4, price_by_weight: 7.18, organic: false)

@produce_item_3 = ProduceItem.create!(farmers_market_stand_id: @stand_2.id, type: "corn", DateTime.new(2021, 4, 22, 3, 11, 45), updated_at: DateTime.new(2020, 3, 10, 12, 15, 30), weight: 3.2, price_by_weight: 6.37, organic: false)

@produce_item_4 = ProduceItem.create!(farmers_market_stand_id: @stand_2.id, type: "peaches", DateTime.new(2021, 4, 26, 7, 13, 33), updated_at: DateTime.new(2020, 3, 10, 12, 15, 30), weight: 2.9, price_by_weight: 8.67, organic: true)

@produce_item_5 = ProduceItem.create!(farmers_market_stand_id: @stand_1.id, type: "potatoes", DateTime.new(2021, 4, 22, 9, 13, 17), updated_at: DateTime.new(2020, 3, 10, 12, 15, 30), weight: 6.2, price_by_weight: 1.37, organic: false)

@produce_item_6 = ProduceItem.create!(farmers_market_stand_id: @stand_2.id, type: "strawberries", DateTime.new(2021, 5, 3, 9, 12, 55), updated_at: DateTime.new(2020, 3, 10, 12, 15, 30), weight: 1.2, price_by_weight: 5.31, organic: true)
